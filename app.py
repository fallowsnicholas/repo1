...
# Custom CSS - Exact Honda-inspired design from JavaScript file
st.markdown("""
<style>
...
def main():
    """Main Streamlit app - Exact copy of JavaScript file with static data"""
    
    # Static sample data - exactly from the JavaScript file
    individual_evs = [
