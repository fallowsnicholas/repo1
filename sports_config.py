...
SPORTS_CONFIG = {
    ...
    'NFL': {
        ...
        'market_mappings': {
            ...
            'anytime_td': 'player_anytime_td_scorer',
            'first_td': 'player_1st_td_scorer',
            'last_td': 'player_last_td_scorer'
        },
        ...
        'correlations': {
            ...
            'player_rush_attempts': {
                'opposing_market': 'player_pass_attempts',
                'correlation_strength': -0.60,
                'bet_logic': 'opposite',
                'same_team': False,
                'description': 'Winning teams run, losing teams pass'
            }
        },
